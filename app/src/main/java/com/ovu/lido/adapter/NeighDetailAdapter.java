...
public class NeighDetailAdapter extends BaseAdapter implements View.OnClickListener {
    private Context mContext;
    private ArrayList<NeiBean.InfoListBean> mList;
    private static String TAG = "NeighDetailAdapter";
    private boolean mFlag = true;


    public NeighDetailAdapter(Context context, ArrayList<NeiBean.InfoListBean> list) {
    ...
    public void setList(ArrayList<NeiBean.InfoListBean> list) {
        this.mList = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.tv_comment_count.setText(mList.get(position).getResponse_count().equals("") ? "0" : mList.get(position).getResponse_count());
