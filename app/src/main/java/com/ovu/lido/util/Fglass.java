...
/**
 * 设置高斯模糊的工具类
 * Created by wangw on 19/6/24.
 *
 * 使用方法：Fglass.blur(image, text, 2, 8);
 */
public class Fglass {
    /**
     * 设置高斯模糊
     * ps:
     * 设置高斯模糊是依靠scaleFactor和radius配合使用的，
     * 比如这里默认设置是：scaleFactor = 8;radius = 2; 模糊效果和scaleFactor = 1;radius = 20;是一样的，而且效率高
     *
