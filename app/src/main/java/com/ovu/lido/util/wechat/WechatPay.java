...
public class WechatPay {
    ...
    private SortedMap<String, String> mPayParam;
    ...
    public static void init(Context context) {
        if (sMWechatPay == null) {
            sMWechatPay = new WechatPay(context, WXConstants.APP_ID);
        }
    }
     ...
     * 发起微信支付
     */
    public void doPay(SortedMap<String, String> pay_param, WXPayResultCallBack callback) {
        mPayParam = pay_param;
        mCallback = callback;
        ...
        if (TextUtils.isEmpty(mPayParam.get("prepayid")) || TextUtils.isEmpty(mPayParam.get("noncestr"))
                || TextUtils.isEmpty(mPayParam.get("timestamp"))) {
            if (mCallback != null) {
