...
public class ChangeTextViewSpace extends AppCompatTextView {
    ...
    public ChangeTextViewSpace(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ChangeTextViewSpace(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
